...
public class FragmentMessageBindingImpl extends FragmentMessageBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.message_list, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.message == variableId) {
            setMessage((com.example.petmily.view.Fragment_Message) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMessage(@Nullable com.example.petmily.view.Fragment_Message Message) {
