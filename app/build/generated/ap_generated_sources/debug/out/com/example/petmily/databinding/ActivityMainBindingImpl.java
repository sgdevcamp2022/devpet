...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.make, 2);
        sViewsWithIds.put(R.id.Appname, 3);
        sViewsWithIds.put(R.id.main_frame, 4);
        sViewsWithIds.put(R.id.bottom_toolbar, 5);
        sViewsWithIds.put(R.id.search, 6);
        sViewsWithIds.put(R.id.home, 7);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.activity == variableId) {
            setActivity((com.example.petmily.view.MainActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.example.petmily.view.MainActivity Activity) {
